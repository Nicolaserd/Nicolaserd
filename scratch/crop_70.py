...
def process_gif():
    ...
    print(f"Original resized height: {clip_resized.size[1]}. Cropping 70px from bottom...")
    # Cut 70px from the bottom
    clip_cropped = clip_resized.cropped(x1=0, y1=0, x2=clip_resized.size[0], y2=clip_resized.size[1]-70)
